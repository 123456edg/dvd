...
//@WebFilter+@ServletComponentScan ，可以解决在过滤器中@Autowired无法自动注入的问题
        ...
        if (StringUtils.isNotBlank(token)) {
            ...
            if (null != sysUserVo) {
                if (curTime > sysUserVo.getTokenExpireTime()) { //当前时间超过此token的最晚有效时间
                    ...
                    //2505600000等于29天 2419200000等于28天 86400000 = 1天
