...
public class CoverController {
    ...
    @ApiOperation(value = "新增封面", notes = "新增封面")
    ...
    @ApiOperation(value = "删除封面", notes = "删除封面")
    ...
    @ApiOperation(value = "修改封面", notes = "修改封面")
    ...
    @ApiOperation(value = "获取封面单个详情", notes = "获取封面单个详情")
    ...
    @ApiOperation(value = "分页查询封面", notes = "分页查询封面")
    @RequestMapping(value = "/findByModal", method = {RequestMethod.POST})
    public Result list(@RequestBody(required =false) Cover cover) {
        PageHelper.startPage(cover.getPage(), cover.getLimit());
        cover.setIsDelete(false);
